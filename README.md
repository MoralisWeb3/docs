...
- Create a new folder in [/docs](/docs)
- Add pages and subpages in the newly created folder 
- Add a link to the main navigation in `navbar.items` in [docusaurus.config.js](docusaurus.config.js)
- Add to [./sidebar.js](./sidebar.js) with
  ...
  ```
- For each sub-folder, make sure to include a `subfolder-name.md` file inside the folder. This file will be used as the landing page for the sub-folder.