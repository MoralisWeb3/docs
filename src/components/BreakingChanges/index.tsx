      ...
      <div className="row justify-center">
        <div className="column" style={{ maxWidth: "42rem" }}>
          ...
          <p>
            ...
            aware of the types of changes that we might make when developing new
            endpoints or iterating on existing ones. Learn about what we
            consider a breaking-change and non-breaking change below.
          </p>
          <h1>Breaking changes</h1>
          <p>
            Breaking changes are typically any changes that might require action
            from our customers (i.e. code changes are required). For all
            breaking changes, we aim to provide you with at least 60 days notice
            prior to making the change. In certains cases related to security,
            privacy or urgent issues related to service resiliency we may reduce
            the 60 day timeframe.
          </p>
          <p>
            <b>Please note:</b> This notice period is applicable to endpoints
            that are made released to general availability. However, for beta,
            experimental, or preview endpoints that are still in the early
            stages, we will continue to make frequent updates as we continue to
            refine them. Such endpoints will be marked as beta or experimental
            on our API reference page. All breaking changes will be communicated
          ...
          <ul>
            ...
            <li>
              Removing a field from the response (a "field" in this case is a
              JSON key/value pair)
            </li>
