...
const RpcChainData = () => {
  ...
  const supportedNodes = chainData.filter(item => item.rpcNodes && item.rpcNodes.supported);

  return (
    <div>
      <Admonition type="tip" title="Supported Chains">
        <p>See the table below for all supported RPC Nodes. For wider chains we support across all products, check the <a href="/supported-chains">full list of supported chains.</a></p>
      </Admonition>
