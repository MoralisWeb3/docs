...
const EVMStreamChainData = () => {
  ...
  const supportedStreamChains = chainData.filter(item => item.streamsApi && item.streamsApi.supported);

  return (
    <div>
      <Admonition type="tip" title="Supported Chains">
        <p>See the table below for all supported chains we support on Streams. For wider chains we support across all products, check the <b><a href="/supported-chains">full list of supported chains.</a></b></p>
      </Admonition>
