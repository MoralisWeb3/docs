...
export default function ChatGPT() {
  ...
  useEffect(() => {
    ...
    if (storedHelpWith && storedIssueRelatedTo) {
      ...
      <DialogContent className="min-w-[60vw] h-[80vh] flex flex-col">
        {!showInput ? (
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h2 className="text-lg font-semibold mb-4">We're here to help!</h2>
            <div className="mb-4">
              <label
                htmlFor="helpWith"
            ...
            <div className="mb-4">
              ...
              >
                ...
                {helpWith === "Moralis" && <option value="API">API</option>}
              </select>
            </div>
            <button
          ...
          <>
            ...
            <div className="flex flex-col h-full">
              <div className="flex-none p-0 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <div>
