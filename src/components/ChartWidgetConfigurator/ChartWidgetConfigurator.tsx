...
const ChartWidgetConfigurator = () => {
    ...
    const [config, setConfig] = useState<WgetForm>(PRICE_CHART_WIDGET_FORM_DEFAULT_VALUES);
                ...
                <div className="flex-1">
                    <Card className="h-full">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <AddressTypeToggle config={config} onChange={handleConfigChange} />
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <TimezoneSelector config={config} onChange={handleConfigChange} />
