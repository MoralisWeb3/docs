...
import { FieldComponentProps, apiParamInitialValue, buildParamPath } from "./ApiParamField";
...
const ApiParamOneOfField = ({ param, field }: FieldComponentProps<"oneOf">) => {
    ...
    const selectOption = useCallback(
        (index: number) => {
            ...
            const oldValues = apiParamInitialValue(param.options[activeIndex], undefined);
            const newValues = apiParamInitialValue(param.options[index], undefined);
