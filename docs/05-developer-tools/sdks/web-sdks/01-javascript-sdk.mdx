---
title: "Moralis client-side Javascript SDK"
...
This introductory guide shows you how to install the client-side Javascript SDK with a script tag or package manager. It allows you to get Web3 Data from [EVM chains](/web3-data-api/evm), [Aptos](/web3-data-api/aptos) and [Solana](/web3-data-api/solana) directly in your frontend.

:::info Rapid Prototyping

Client-side Web3 Data is great for rapid prototyping and testing out your idea. If you're looking for more control consider setting up a backend and using one of our [Server-side SDKs](/developer-tools/sdks/server-side-sdks).
...
To start using Moralis, change `YOUR_API_KEY` to your client-side [API Key](https://admin.moralis.io/web3apis) and initialize it via the start() method:
...
Once the Moralis Javascript SDK is initialized, you will be able to use all the Web3 Data APIs provided by Moralis to build your dapps.
...
```html
<script src="https://unpkg.com/moralis@2.17.0/dist/moralis.min.js"></script>
```
...
<html>
  ...
  <body>
    ...
    "/index.js": `if(!Moralis.Core.isStarted){
  Moralis.start({
    apiKey: "YOUR_API_KEY"
  });
}
...
## Load Moralis as an ES Module

### Installation

To install by package manager, install the Moralis ES Module from the npm public registry.
...
Next, import the module into a JavaScript file. Then change `YOUR_API_KEY` to your client-side [API Key](https://admin.moralis.io/web3apis) and initialize it via the start() method:
...
<html>
  ...
  <body>
    ...
    "/index.js": `import Moralis from 'moralis';
