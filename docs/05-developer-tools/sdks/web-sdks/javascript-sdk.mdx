...
Client-side Web3 Data is great for rapid prototyping and testing out your idea. If you're looking for more control consider setting up a backend and using one of our [Server-side SDKs](/developer-tools/sdks/server-sdks).
