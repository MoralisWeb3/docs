...
In this app we use [get Wallet NFTs](https://docs.moralis.io/docs/how-to-get-spl-nft-balance-of-an-address) endpoint, to fetch all the NFTs of a wallet and we use [get NFT Metadata](https://docs.moralis.io/docs/how-to-get-spl-nft-metadata) endpoint to get the metadata of the wallet NFTs.
