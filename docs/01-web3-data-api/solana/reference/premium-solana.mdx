...
| --- | --------------- | ---------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| 1  | `getTokenScore` | Get token score  | [Method Documentation](/web3-data-api/solana/reference/get-token-score) | [https://deep-index.moralis.io/api/v2.2/tokens/:tokenAddress/score](https://deep-index.moralis.io/api/v2.2/tokens/:tokenAddress/score) |
