...
| "Find trending tokens on Solana"                        | [`searchTokens`](https://docs.moralis.com/web3-data-api/solana/reference/search-tokens)                                    | Searches for Solana tokens by name or symbol                     |
...
| "Find trending tokens across all chains"                      | Call [`searchTokens`](https://docs.moralis.com/web3-data-api/evm/reference/search-tokens) with multiple chain parameters                                                                                                         | Performs cross-chain token discovery                 |
