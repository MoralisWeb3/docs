...
slug: "../../evm/metadata-normalization"
...
Through our [NFT APIs](/web3-data-api/evm/nft-api), you have the option to receive either a [normalized or non-normalized NFT metadata](/web3-data-api/evm/resources/normalized-vs-non-normalized-metadata).
