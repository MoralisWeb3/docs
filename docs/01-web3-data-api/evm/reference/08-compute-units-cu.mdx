...
For Moralis Streams, each record has a fixed cost of 15 Compute Units. You can read more about records and Streams pricing on the [Streams pricing page](/streams-api/evm/records-and-pricing).
