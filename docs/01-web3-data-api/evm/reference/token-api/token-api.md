...
| 25  | `getHistoricalTokenHolders` | Get ERC20 token holders Stats Timeseries | [Method Documentation](/web3-data-api/evm/reference/get-historical-token-holders) | [https://deep-index.moralis.io/api/v2.2/erc20/:address/holders/historical](https://deep-index.moralis.io/api/v2.2/erc20/:address/holders/historical) |
