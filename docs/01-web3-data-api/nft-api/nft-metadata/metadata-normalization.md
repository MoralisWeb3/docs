...
Through our [NFT APIs](/web3-data-api/nft-api), you have the option to receive either a [normalized or non-normalized NFT metadata](/web3-data-api/nft-api/nft-metadata/normalized-vs-non-normalized-metadata).
