...
3. Add and populate a `ChallengeRequestDto` object. This object is described in detail [here](https://docs.moralis.io/reference/auth-api-overview#how-it-works). Populate this object as appropriate for your application.
