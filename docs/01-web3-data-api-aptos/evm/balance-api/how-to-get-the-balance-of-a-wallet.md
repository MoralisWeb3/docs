...
In order to get the native balance of a wallet address, Moralis provides you the [getNativeBalance](/web3-data-api/reference/get-native-balance) API endpoint.
