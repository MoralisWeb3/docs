...
<div className="container">
    <div className="row">
        ...
        <div className="col col--6">
            <div className="col-demo margin-bottom--lg">
                <a className="card padding--lg card--homepage" href="/authentication-api/reference/request-challenge-solana">
                    ...
                    <p>Authenticate and verify any user's Solana wallet.</p>
                </a>
            </div>
        </div>
    </div>
