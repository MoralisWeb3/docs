...
Make sure that you have installed all the following prerequisites:
  ...
  - <a href="https://nodejs.org/">Node.js</a> v14+ or [Python](https://www.python.org/downloads/)
  - <a href="https://www.npmjs.com/">NPM</a> /[Yarn](https://classic.yarnpkg.com/en/) or [Pip](https://pip.pypa.io/en/stable/)
