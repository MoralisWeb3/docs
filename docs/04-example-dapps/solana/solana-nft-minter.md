...
We will use [Metaplex JavaScript SDK](https://github.com/metaplex-foundation/js) and the [Moralis API](/web3-data-api-solana/solana/how-to-get-native-solana-balance-by-wallet) to mint and view the NFTs.
