...
<AccordionGroup>
  <Accordion title="What metadata is returned for NFTs on Solana?">
...
<Accordion title="Are NFT media items now available for Solana?">
...
<Accordion title="What fields can I expect in a full NFT metadata response?">
...
<Accordion title="How are NFT attributes/traits structured?">
...
<Accordion title="Why do some NFTs have missing or partial metadata?">
...
<Accordion title="What is in the Metaplex-specific data?">
...
<Accordion title="How is creator information structured?">
...
<Accordion title="How do I retrieve metadata for a specific NFT?">
...
<Accordion title="How do I get all NFTs owned by an address with metadata?">
...
<Accordion title="What information is available in the firstCreated field?">
...
<Accordion title="What additional properties are included?">
...
<Accordion title="What does the media object contain?">
