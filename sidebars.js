...
const sidebars = {
    ...
    moralisCortexSidebar: [
        ...
        },
        {
            ...
            link: {
                type: "generated-index",
                slug: "cortex/reference",
                title: "Cortex API Reference",
                description:
                    "Explore the Moralis Cortex API endpoints for AI-powered blockchain interactions.",
            },
            items: [
                {
                    type: "autogenerated",
                    dirName: "08-moralis-cortex/reference",
                },
            ],
        },
        {
