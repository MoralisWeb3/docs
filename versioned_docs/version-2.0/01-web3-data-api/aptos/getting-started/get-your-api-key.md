...
Get your Web3 API key from the [Moralis dashboard](https://admin.moralis.com/) by going to one of your existing project > Settings > Secrets > Copy one of your secrests.
